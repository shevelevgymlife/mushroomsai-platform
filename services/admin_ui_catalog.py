...
_ADMIN_ITEMS_RAW: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "href": "/admin/payment",
        "perm": "can_payment",
        "subtitle": "Провайдеры, тарифы, основной способ оплаты",
        "help": (
            "<p><b>Что это:</b> CloudPayments, две карточки ЮKassa (веб и бот/Mini App), Stars, черновики других провайдеров; "
            "каталог цен подписок.</p>"
            "<p><b>На что влияет:</b> как пользователь оплачивает подписку и в каком магазине ЮKassa создаётся платёж.</p>"
            "<p><b>Сохранение:</b> на каждой подстранице провайдера и в «Тарифы подписок» — отдельные формы.</p>"
        ),
    },
    {
        "id": "shop",
        ...
        "help": (
            ...
            "<p><b>Сохранение:</b> карточки товаров — свои кнопки; раздел «Рефералы · Макси» — отдельная форма сохранения хаба.</p>"
        ),
    },
    {
        "id": "homepage",
    ...
    },
    {
        ...
        "help": (
            ...
            "<p><b>Сохранение:</b> отдельные действия на странице (привязка, включение).</p>"
        ),
    },
    {
    ...
    },
    {
        ...
        "help": (
            "<p><b>Что это:</b> глобальные настройки текстового AI: системный промпт, параметры, тест от имени админа.</p>"
            "<p><b>На что влияет:</b> ответы AI во всех сценариях, где подключается этот слой.</p>"
            "<p><b>Сохранение:</b> форма страницы / отдельные POST по разделам — смотрите кнопки на экране.</p>"
        ),
    },
    {
        "id": "ai_posts",
