...
_ADMIN_ITEMS_RAW: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "perm": "can_payment",
        "subtitle": "Пул NFI↔бонусы, coverage, автодолив",
        "help": (
            "<p><b>Что это:</b> внутренний пул обмена бонусов и токена NFI, добавление ликвидности и опциональный автодолив при росте числа пользователей.</p>"
            "<p><b>На что влияет:</b> курс на странице /exchange и доступный объём сделок; уведомления ops при низком coverage.</p>"
